...
dim(my.sppBYsites) #the number of rows (plots) and columns (species) in the matrix
...
```{r, fig.height = 4, fig.width = 6}
#Whittaker plots for selected AusPlots:
goeveg::racurves(my.sppBYsites[10:15,], bw=F)

#And then with alternative relative abundance models fitted for one community:
