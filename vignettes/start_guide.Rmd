...
Next, we need to merge the fractional cover scores with longlat coordinates from the site information table. Vegetation survey data are identified by the 'site_unique' field, which is unique combination of site ID ('site_location_name') and visit ID ('site_location_visit_id'):
